	...
	ERHIFeatureLevel::Type FEATURE_LEVEL)
{
	...
	Dst.WRITES_VELOCITY_TO_GBUFFER = (Dst.SUPPORTS_WRITING_VELOCITY_TO_BASE_PASS || Dst.USES_GBUFFER) &&
									 ...
									 (!Mat.COMPUTE_SHADED || SrcGlobal.USES_BASE_PASS_VELOCITY || Mat.USES_WORLD_POSITION_OFFSET || Mat.USES_FIRST_PERSON_INTERPOLATION);
	...
	Dst.SUBSTRATE_GBUFFER_FORMAT = Mat.SUBSTRATE_GBUFFER_FORMAT;
