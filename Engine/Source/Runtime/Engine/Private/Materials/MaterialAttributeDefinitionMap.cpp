...
void FMaterialAttributeDefinitionMap::InitializeAttributeMap()
{
	...
	AddCustomAttribute(FGuid(0xB58CD3FB, 0x8CB4411D, 0x83C4C11E, 0xF89953AD), UMaterialExpressionTemporalResponsivenessOutput::StaticClass(), "TemporalResponsiveness", "GetTemporalResponsivenessOutput", 0, MCT_Float, FVector4(0, 0, 0, 0), SF_Pixel);
	AddCustomAttribute(FGuid(0x48A2CEAB, 0x8E63473F, 0x821345BC, 0x6FA907F7), UMaterialExpressionMotionVectorWorldOffsetOutput::StaticClass(), "MotionVectorWorldOffset", "GetMotionVectorWorldOffsetOutput", 0, MCT_Float3, FVector4(0, 0, 0, 0), SF_Pixel);
}
